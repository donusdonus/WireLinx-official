...
5. **PLC Basic Programming Exercises**
    ...
    5.2 Create a program to control the operation of a relay using a start and stop button.
    5.3 timer to turn off relay automatically after a preset time.
    5.4 Write a program to count the number of cycle.
