...
5. **PLC Basic Programming Exercises**
    5.1 Write a simple ladder logic program to turn on an output when a switch is pressed.
    5.2 Create a program to control the operation of a motor using a start and stop button.
    5.3 Write a simple ladder logic program to turn on an output when a switch is pressed.
    5.4 Write a simple ladder logic program to turn on an output when a switch is pressed.
    5.5 Write a simple ladder logic program to turn on an output when a switch is pressed.
    5.6 Write a simple ladder logic program to turn on an output when a switch is pressed.
