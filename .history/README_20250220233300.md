...
3. **Programming with GX-WORK 2**
   - new project and test connection (5 min.)[Example](https://youtu.be/2iR9Q22t5_0)
   - download (5 min.)[Example](https://youtu.be/Tfad3BvSHQI)
   - upload (5 min.)[Example](https://youtu.be/ina59Y-c82w)
   - monitoring and modify value (10 min.)[Example](https://youtu.be/pGsTwQJBvRU)
...
5. **PLC Basic Programming Exercises**
    ...
    - Convert Electrical function process to ladder logic process.
