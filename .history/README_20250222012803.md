...
- **Reset PLC :** Used to restart the PLC without affecting saved configurations.
![alt text](image-30.png)
- **Run/Stop PLC :** Can be programmed for specific functions such as mode 
- **Reset parameter config:** Can be programmed for specific functions such as mode selection or manual override.
...
3.1 Create simple ladder logic program to turn on an output when a switch is pressed<p>
    ...
    <p style="text-align: center;">
       <img src="image-27.png" width="70%">
    </p><br>
    3.4 Write program to counter the number of cycle.<p>
    <p style="text-align: center;">
       <img src="image-28.png" width="70%">
    </p><br>
